...
\basicInfo{
  \email{jiaxg1998@sjtu.edu.com} \textperiodcentered \
...
\begin{itemize}
  \item 上海市可扩展计算与系统重点实验室\ \ \textbf{研究方向:} 系统虚拟化、操作系统  \ \  \textbf{导师:} 戚正伟教授
\end{itemize}
...
\datedsubsection{\textbf{SJTU}, 可信云计算实验室 (TCloud)}{2019年6月 -- 至今}
\textbf{GiantVM:} 设计新的线程调度算法，从而优化内存密集型应用在GiantVM上运行的性能
...
\datedline{参与编写《深入浅出系统虚拟化:原理与实践》，获得教育-华为智能基座“突出贡献奖”}{2022 年1 月}
